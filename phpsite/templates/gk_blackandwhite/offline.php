...
<link rel="stylesheet" href="<?php echo $this->baseurl ?>/templates/gk_blackandwhite/css/system/offline.css" type="text/css" />
<?php if($this->direction == 'rtl') : ?>
<link rel="stylesheet" href="<?php echo $this->baseurl ?>/templates/gk_blackandwhite/css/system/offline_rtl.css" type="text/css" />
<?php endif; ?>
    ...
    <div id="bg-wrap">
        ...
        <div id="frame">
           ...
           <jdoc:include type="message" />
                <p class="info"><strong><?php echo $mainframe->getCfg('offline_message'); ?></strong></p>
